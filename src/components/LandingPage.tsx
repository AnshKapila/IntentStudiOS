...
export const LandingPage: React.FC<LandingPageProps> = ({ onGetStarted }) => {
  ...
  return (
    <div className="bg-[#050505] text-white min-h-screen font-sans selection:bg-orange-500 selection:text-white" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <nav className="fixed top-0 left-0 right-0 z-40 px-6 py-6 flex justify-center">
        <div className="w-full max-w-5xl rounded-full border border-white/[0.08] bg-white/[0.03] backdrop-blur-[12px] flex items-center justify-between px-6 py-3">
          <div className="flex items-center gap-2 cursor-pointer" onClick={onGetStarted}>
            <span className="text-2xl text-orange-500" style={{ fontFamily: 'var(--font-logo)' }}>I</span>
      ...
      <section className="relative pt-40 pb-20 px-6 flex flex-col items-center justify-center text-center animate-on-scroll">
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto h-[600px] border border-white/10 rounded-2xl bg-[#0c0c0c] shadow-[0_0_15px_rgba(249,115,22,0.4)] overflow-hidden flex flex-col">
          ...
          <div className="h-12 border-b border-white/5 flex items-center px-4 justify-between bg-black/40">
            ...
            <div className="text-xs text-gray-500 font-mono flex gap-2 items-center">
              ...
              <span>/</span>
              <span className="text-orange-400">orchestration</span>
            </div>
          ...
          <div className="flex-1 flex relative">
            ...
            <div className="absolute left-1/2 top-0 bottom-0 w-[2px] -translate-x-1/2 z-0 overflow-hidden">
              <div className="w-full h-32 bg-gradient-to-b from-transparent via-orange-500 to-transparent energy-drop shadow-[0_0_8px_#f97316]"></div>
            </div>
            ...
            <div className="w-64 border-r border-white/5 p-4 z-20 bg-[#0a0a0a]/80 backdrop-blur-sm">
              <div className="mb-6 relative">
                ...
                <input type="text" placeholder="Fleet Command..." className="w-full bg-white/5 border border-white/10 rounded-lg pl-9 pr-3 py-2 text-xs focus:outline-none focus:border-orange-500/50" />
              </div>
              <div className="space-y-1">
                <div className="text-[10px] uppercase tracking-widest text-gray-600 font-semibold mb-2 px-2">Active Modules</div>
                <div className="flex items-center gap-3 px-3 py-2 rounded-lg bg-orange-500/10 border-l-2 border-orange-500 text-orange-400 cursor-pointer">
            ...
            <div className="flex-1 dot-bg relative overflow-hidden z-10">
              ...
              <svg className="absolute inset-0 w-full h-full z-0 pointer-events-none">
                <path d="M 200 180 C 250 180, 250 100, 350 100" fill="none" stroke="#f97316" strokeWidth="2" strokeOpacity="0.4" className="svg-line" />
                <path d="M 200 180 C 250 180, 250 280, 350 280" fill="none" stroke="#f97316" strokeWidth="2" strokeOpacity="0.4" className="svg-line" />
                <path d="M 550 100 C 600 100, 600 180, 680 180" fill="none" stroke="#f97316" strokeWidth="2" strokeOpacity="0.4" className="svg-line" />
                
                {/* Pulse points */}
                <circle cx="200" cy="180" r="4" fill="#f97316" className="animate-pulse shadow-[0_0_8px_#f97316]" />
                <circle cx="350" cy="100" r="4" fill="#f97316" className="animate-pulse shadow-[0_0_8px_#f97316]" />
                <circle cx="350" cy="280" r="4" fill="#f97316" className="animate-pulse shadow-[0_0_8px_#f97316]" />
              </svg>
              ...
              <div className="absolute z-10 bg-[#111] border border-white/10 rounded-xl p-4 w-48 shadow-lg backdrop-blur-md" style={{ left: '50px', top: '140px' }}>
                ...
                <div className="space-y-2">
                  ...
                  <div className="h-1.5 w-full bg-white/5 rounded-full overflow-hidden">
                    <div className="h-full w-[60%] bg-orange-500/50 rounded-full"></div>
                  </div>
                </div>
              </div>

              {/* Node 2: SDR Agent */}
              <div className="absolute z-10 bg-[#111] border border-orange-500/30 rounded-xl p-4 w-52 shadow-[0_0_15px_rgba(249,115,22,0.15)] backdrop-blur-md" style={{ left: '350px', top: '40px' }}>
                <div className="flex justify-between items-center mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-semibold text-orange-400">Agent: SDR</span>
                  </div>
            ...
            <div className="w-72 border-l border-white/5 p-4 z-20 bg-[#0a0a0a]/80 backdrop-blur-sm flex flex-col">
              ...
              <div className="flex-1 bg-black/50 border border-white/5 rounded-lg p-3 font-mono text-[10px] text-gray-400 relative">
                <div className="text-orange-400 mb-2">// Active Protocol: Prospecting</div>
                ...
                <div>);<span className="inline-block w-1.5 h-3 bg-orange-500 ml-1 animate-blink align-middle"></span></div>
              </div>
            </div>
      ...
      <section id="capabilities" className="py-32 px-6 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 bg-[#0c0c0c] border border-white/5 rounded-3xl p-8 hover:border-white/10 transition-colors animate-on-scroll flex flex-col justify-between group overflow-hidden relative">
            <div className="relative z-10 mb-12">
              <div className="w-12 h-12 rounded-xl bg-orange-500/10 flex items-center justify-center mb-6">
                <iconify-icon icon="lucide:target" className="text-2xl text-orange-400"></iconify-icon>
              </div>
            ...
            <div className="relative z-10 bg-[#151515] rounded-xl border border-white/5 p-4 w-3/4 self-end shadow-xl transform translate-y-2 group-hover:-translate-y-2 transition-transform duration-500">
              <div className="flex justify-between text-xs text-gray-400 mb-2">
                ...
                <span className="text-orange-400 font-mono">98%</span>
              </div>
              <div className="h-1.5 w-full bg-white/5 rounded-full overflow-hidden">
                <div className="h-full w-[98%] bg-gradient-to-r from-orange-600 to-orange-400 rounded-full relative">
          ...
          <div className="md:col-span-1 bg-[#0c0c0c] border border-white/5 rounded-3xl p-8 hover:border-white/10 transition-colors animate-on-scroll flex flex-col justify-between overflow-hidden relative">
            ...
            <div className="relative z-10 bg-black/50 rounded-xl border border-white/5 border-l-2 border-l-orange-500 p-4 font-mono text-[10px] text-gray-400">
              <span className="text-green-400">✔</span> Candidate matched<br/>
              <span className="text-green-400">✔</span> Portfolio verified<br/>
              <span className="text-orange-400">⟳</span> Scheduling interview...
            </div>
          </div>
          ...
          <div className="md:col-span-1 bg-[#0c0c0c] border border-white/5 rounded-3xl p-8 hover:border-white/10 transition-colors animate-on-scroll">
            ...
            <button onClick={onGetStarted} className="flex items-center gap-2 text-sm font-semibold hover:text-orange-400 transition-colors">
          ...
          <div className="md:col-span-2 bg-[#0c0c0c] border border-white/5 rounded-3xl p-8 hover:border-white/10 transition-colors animate-on-scroll flex flex-col md:flex-row items-center gap-8 group">
            ...
            <div className="flex-1 w-full h-40 flex items-end justify-between gap-2 border-b border-white/10 pb-2 px-2">
              {[40, 60, 45, 80, 65, 90, 100].map((h, i) => (
                <div key={i} className="w-full bg-orange-500/20 rounded-t-sm transition-all duration-500 group-hover:bg-orange-500/80" style={{ height: `${h * 0.5}%` }}>
                  <div className="w-full bg-orange-400 transition-all duration-700 delay-100 group-hover:h-[90%]" style={{ height: `${h * 0.8}%` }}></div>
                </div>
              ))}
            </div>
          </div>
      ...
      <section id="pricing" className="py-32 px-6 max-w-6xl mx-auto border-t border-white/5 animate-on-scroll">
        <div className="text-center mb-16">
          ...
          <div className="inline-flex items-center p-1 bg-white/5 rounded-full border border-white/10 mx-auto mt-8 relative">
            ...
            <button className="relative z-10 px-6 py-2 text-sm font-medium text-gray-400 w-32">Yearly <span className="text-[10px] text-orange-400 ml-1">Save 20%</span></button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-[#0a0a0a] border border-white/5 rounded-3xl p-8 flex flex-col hover:border-white/20 transition-colors">
            ...
            <ul className="space-y-4 mb-8 flex-1 text-sm text-gray-300">
              <li className="flex gap-3"><iconify-icon icon="lucide:check-circle-2" className="text-orange-500 text-lg"></iconify-icon> Up to 3 Active Projects</li>
              <li className="flex gap-3"><iconify-icon icon="lucide:check-circle-2" className="text-orange-500 text-lg"></iconify-icon> Basic CRM & Leads</li>
              <li className="flex gap-3"><iconify-icon icon="lucide:check-circle-2" className="text-orange-500 text-lg"></iconify-icon> Manual Invoicing</li>
            </ul>
          ...
          {/* Tier 2 */}
          <div className="bg-[#0c0c0c] border border-orange-500/50 shadow-[0_0_20px_rgba(249,115,22,0.15)] rounded-3xl p-8 flex flex-col relative transform md:-translate-y-4">
            <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-orange-600 to-orange-400 rounded-t-3xl"></div>
            <h3 className="text-lg text-orange-400 mb-2">Growth Engine</h3>
            ...
            <ul className="space-y-4 mb-8 flex-1 text-sm text-gray-300">
              <li className="flex gap-3"><iconify-icon icon="lucide:check-circle-2" className="text-orange-500 text-lg"></iconify-icon> Unlimited Projects</li>
              <li className="flex gap-3"><iconify-icon icon="lucide:check-circle-2" className="text-orange-500 text-lg"></iconify-icon> AI SDR Swarm (500 leads/mo)</li>
              <li className="flex gap-3"><iconify-icon icon="lucide:check-circle-2" className="text-orange-500 text-lg"></iconify-icon> Automated Hiring Pipelines</li>
              <li className="flex gap-3"><iconify-icon icon="lucide:check-circle-2" className="text-orange-500 text-lg"></iconify-icon> Automated Invoicing & Escrow</li>
            </ul>
            <button onClick={onGetStarted} className="w-full py-3 rounded-xl bg-orange-600 hover:bg-orange-500 transition-colors text-white text-sm font-medium shadow-[0_0_15px_rgba(249,115,22,0.4)]">Start Free Trial</button>
          </div>
      ...
      {/* Footer CTA */}
      <footer className="py-24 px-6 text-center border-t border-white/5 bg-gradient-to-t from-orange-900/10 to-transparent animate-on-scroll relative overflow-hidden">
        <div className="absolute left-1/2 bottom-0 w-[600px] h-[300px] bg-orange-500/20 blur-[120px] rounded-full -translate-x-1/2 pointer-events-none"></div>
